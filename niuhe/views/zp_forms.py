...
class EnumSelectField(SelectField):
    ...
    def __init__(self, label = None, group = None, *args, **kwargs):
        kwargs['choices'] = group.get_choices()
        kwargs['coerce'] = type(group.get_title_dict().keys()[0])
        super(EnumSelectField, self).__init__(label, *args, **kwargs)
